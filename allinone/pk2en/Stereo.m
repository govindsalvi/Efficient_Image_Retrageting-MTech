...
%   ***********************************************************************
    lightfile = strcat( directory, '', 'calibratedLight.txt');
...
%   *************************************************************************
    maskfile  = strcat( directory, '', imagename, '/', imagename,'.mask.png');
    maskImage = rgb2gray(imread( maskfile ));
...
%   Read all the images..
    for im = 1:numImages
        id = num2str(im-1);
        filename = strcat( directory, '', imagename, '/', imagename, '.', id, '.png');
